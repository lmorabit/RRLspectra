...
;	version 1.0 01/23/2013: Initial version
	...
	readcol,'/net/leubeek/data2/LLINE/RRL_CI_alpha.txt',ca1, ca2, cann, c_freq, format='A,A,D,D'
	;;readcol,'/net/leubeek/data2/LLINE/RRL_CI_beta.txt',ca1, ca2, cann, c_freq, format='A,A,D,D'
	;;readcol,'/net/leubeek/data2/LLINE/RRL_CI_gamma.txt',ca1, ca2, cann, c_freq, format='A,A,D,D'
